...
def mixed_loss(labels, embeddings, margin, ratio=0.5):
    l1 = batch_hard_triplet_loss(labels, embeddings, margin)
    l2 = tf.contrib.losses.metric_learning.triplet_semihard_loss(labels, embeddings, margin)
    loss = (l1*ratio)+((1-ratio)*l2)
    return loss
